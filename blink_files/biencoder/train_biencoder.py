...
def evaluate(
    ...
    for step, batch in enumerate(iter_):
        ...
        with torch.no_grad():
            eval_loss, logits = reranker(context_input, candidate_input, add_metadata=False)
...
def main(params):
    ...
    # Init model
    # TODO (I think): to train from checkpoint, instead of initializing, lood biencoder here?
    ...
    for epoch_idx in trange(int(num_train_epochs), desc="Epoch"):
        ...
        for step, batch in enumerate(iter_):
            ...
            context_input, candidate_input, _ = batch
            # context_input, candidate_input, _, _ = batch
            loss, _ = reranker(context_input, candidate_input, add_metadata=False)
    ...
    print(f'the WEIGHTS_NAME is {WEIGHTS_NAME}')
