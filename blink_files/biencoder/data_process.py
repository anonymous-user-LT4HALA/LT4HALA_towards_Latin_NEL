...
def get_context_representation(
    ...
    padding = [tokenizer.convert_tokens_to_ids(pad_token)] * (max_seq_length - len(input_ids))
    input_ids += padding
...
def process_mention_data(
    ...
    if add_metadata:
        data = {
            ...
            "cand_vecs": cand_vecs,
            "label_idx": label_idx,
            "date": [float(sample["metadata"]["mention_end_date"]) for sample in samples],
            "mention": [sample['mention'] for sample in samples],
        }
    else:
        data = {
            "context_vecs": context_vecs,
